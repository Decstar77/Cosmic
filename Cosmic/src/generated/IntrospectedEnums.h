...
case EntityType::DIRECTIONALLIGHT: return "DIRECTIONALLIGHT";
...
if (entry == "POINTLIGHT") return EntityType::POINTLIGHT;
if (entry == "SPOTLIGHT") return EntityType::SPOTLIGHT;
if (entry == "DIRECTIONALLIGHT") return EntityType::DIRECTIONALLIGHT;
