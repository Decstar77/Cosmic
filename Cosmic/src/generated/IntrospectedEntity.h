...
ImGui::DragFloat("shadow_near", &directionallight->shadow_near);
ImGui::DragFloat("shadow_far", &directionallight->shadow_far);
ImGui::DragFloat("shadow_width", &directionallight->shadow_width);
ImGui::DragFloat("shadow_height", &directionallight->shadow_height);
ImGui::TreePop();
}
;
}
...
ImGui::DragFloat("innner", &spotlight->innner);
